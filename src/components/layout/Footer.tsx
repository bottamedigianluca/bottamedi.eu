...
const Footer: React.FC<FooterProps> = ({ language }) => {
  ...
  // 🔓 FUNZIONE PER SBLOCCARE I DOCUMENTI LEGALI
  const handleLegalDocumentClick = (docType: 'privacy' | 'terms' | 'cookies') => {
    // Dispatch evento personalizzato per comunicare con LegalDocuments component
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-white/80">
              ...
              <p className="flex items-center space-x-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.
