                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {t.sections.map((item, index) => (
                      <motion.button
                        ...
                        className="relative flex items-center p-4 rounded-2xl transition-all duration-200 min-h-[60px] bg-gray-50 text-gray-700 hover:bg-gray-100 shadow-sm hover:shadow-md"
